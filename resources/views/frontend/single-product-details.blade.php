                        ...
                        <div class="p-l-25 p-r-30 p-lr-0-lg">
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb">
                                    ...
                                    <div class="item-slick3" data-thumb="{{ URL::to('/') }}/upload/product_image/product_sub_image/{{$s_image->sub_image}}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ URL::to('/') }}/upload/product_image/product_sub_image/{{$s_image->sub_image}}" alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ URL::to('/') }}/upload/product_image/product_sub_image/{{$s_image->sub_image}}">
                                        ...
                                        <div class="size-204 respon6-next">
                                            <div class="rs1-select2 bor8 bg0">
                                                <select class="js-select2" name="size_id">
                                                    ...
                                                    <option value="{{ $size->size_id }}">{{ $size->sizes->name }}</option>
                                                    @endforeach
                                                </select>
