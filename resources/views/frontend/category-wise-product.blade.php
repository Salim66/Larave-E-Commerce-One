            ...
            <div class="container">
                <div class="flex-w flex-sb-m p-b-52">
                    <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                        <a href="{{ route('products.list') }}"  class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1"> All Products</a>
                    ...
                    <!-- Filter -->
                    @php
                        $brands = App\Models\Product::select('brand_id')->groupBy('brand_id')->get();
                     @endphp
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img style="width: 300px; height:200px;" src="{{ URL::to('/') }}/upload/product_image/{{ $product->image }}" alt="IMG-PRODUCT">

                                    <a href="{{ route('single.product.detials.info', $product->slug) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                        Add to Card
                                    </a>
                                </div>
