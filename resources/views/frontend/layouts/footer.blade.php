    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-6 p-b-50">
                ...
                <ul class="social">
                    ...
                    <li class="linkedin"><a href="{{ $contact->linkdin }}" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="p-t-40">
            <p class="stext-107 cl6 txt-center">
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> @FF. Designed & Developed By Salim66
            </p>
        </div>
    </div>
</footer>
